...
class PrimitiveField(ttk.Frame):
    ...
    def __init__(self, master, value, colors):
...
class _Collapsible(ttk.Frame):
    ...
    def __init__(self, master, title, colors, extra=None):
        super().__init__(master)
        self._colors = colors
        self._expanded = True
...
class ObjectEditor(_Collapsible):
    ...
    def __init__(self, master, obj, colors):
...
class ArrayEditor(_Collapsible):
    ...
    def __init__(self, master, arr, colors):
        self._items = []
    ...
    def _add_item(self, value):
        ...
        remove = ttk.Button(
            ...
            command=lambda f=item_frame: self._remove_item(f),
        )
